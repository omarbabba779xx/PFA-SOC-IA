...
Avec ces deux captures, les **cinq premiers outils de la chaîne** (Wazuh, Shuffle, TheHive, Cortex, MISP) tracent le **même incident unique**, du premier signal de reconnaissance jusqu'à la capitalisation de threat intelligence — pas cinq démonstrations juxtaposées après coup. Le sixième outil, Gemma2 9B, est documenté séparément ci-dessous sur le chemin de criticité qui lui est propre.
